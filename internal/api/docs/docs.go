    ...
    "components": {
        "schemas": {
            "accessrequests.AccessRequest": {
                "properties": {
                    "expiresAt": {
                        "description": "ExpiresAt is set for approved landing-owned entitlements. Once this time\npasses, the approval no longer grants service access.",
                        "type": "string"
                    },
                    "id": {
                    ...
                    "resolvedAt": {
                        "description": "ResolvedAt is set when the request is approved, denied, or revoked.",
                        "type": "string"
                    },
                    "resolvedBy": {
                        "description": "ResolvedBy is the stable user ID of the admin who approved, denied, or revoked the request.",
                        "type": "string"
                    },
                    "resolvedByEmail": {
                        "description": "ResolvedByEmail is the email of the admin when present in the JWT.",
                        "type": "string"
                    },
                    "resolvedByName": {
                        "description": "ResolvedByName is the display name of the admin when present in the JWT.",
                        "type": "string"
                    },
                    "serviceName": {
                    ...
                    "targetOwner": {
                        "description": "TargetOwner identifies the service owner/definition for audit. Today this\nis the target NebariApp namespace/name.",
                        "type": "string"
                    },
                    "userEmail": {
                    ...
                    "userID": {
                        "description": "UserID is the caller's stable JWT subject (or preferred_username fallback\nin development/test modes that do not provide sub).",
                        "type": "string"
                    }
                },
                "type": "object"
    ...
    "paths": {
        "/admin/access-requests": {
            "get": {
                ...
                "parameters": [
                    {
                        "description": "Filter by status: pending, approved, denied, or revoked",
                        "in": "query",
                        "name": "status",
                        "schema": {
                            "type": "string"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.AccessRequestListResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/admin/access-requests/{id}/{action}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "approve | deny | revoke",
                        "in": "path",
                        "name": "action",
                        "required": true,
                        "schema": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        ...
                        "description": "Pending request or active entitlement already exists"
                    },
                    "501": {
                        "content": {
                            "application/json": {
